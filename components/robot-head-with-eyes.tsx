...
export default function RobotHeadWithEyes() {
  ...
  const handleMouseMoveEyes = (e: MouseEvent) => {
    ...
    const centerY = rect.top + rect.height / 3 // Posunuto výše, kde jsou oči

    // Výpočet úhlu mezi středem obličeje a kurzorem
    const angle = Math.atan2(e.clientY - centerY, e.clientX - centerX)

    // Omezení pohybu očí (max 15% od středu)
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Maska pro překrytí původních očí */}
          <div className="absolute inset-0 z-10 pointer-events-none">
            <div
              className="absolute bg-white/0"
              style={{
                width: "14%",
                height: "5%",
                left: "35%",
