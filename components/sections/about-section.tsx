    ...
    <section id="about" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">O nás</h2>
        ...
        <div className="mt-16">
          <h3 className="text-2xl font-semibold text-center mb-12">Náš tým</h3>
        ...
        <div className="mt-20 bg-gray-50 rounded-2xl p-8 md:p-12">
          <div className="md:grid md:grid-cols-2 md:gap-12 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-gray-900">Naše mise</h3>
            ...
            <div className="mt-8 md:mt-0">
              <h3 className="text-2xl font-semibold text-gray-900">Naše hodnoty</h3>
